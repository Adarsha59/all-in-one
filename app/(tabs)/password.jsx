...
import homepageimage from "../../assets/images/pass.png"; // Ensure this path is correct
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        <View style={styles.secondContainer} resizeMode="cover">
          <Text style={styles.titleText}>PASSWORD GENERATOR APP</Text>
          <TouchableOpacity
            style={styles.textview}
            onPress={() => router.push("/password/PassGen")}
          >
