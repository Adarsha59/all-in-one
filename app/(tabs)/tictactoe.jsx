...
import homepageimage from "../../assets/images/tik.png"; // Ensure this path is correct
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        <View style={styles.secondContainer} resizeMode="cover">
          <Text style={styles.titleText}>TIK TAK TOE APP</Text>
          <TouchableOpacity
            style={styles.textview}
            onPress={() => router.push("/ttt/TikTakToe")}
          >
